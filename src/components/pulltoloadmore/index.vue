    ...
    <div ref="pulltoloadmorewraper" class="wk-pulltoloadmore">
        <div ref="pulldown" class="wk-pulldown">
            <slot name="pulldown">
                ...
                <circular class="wk-pull-circular" v-show="pullDownLoading" :size="24" color="carbon"></circular>
        ...
        <div ref="pullup" class="wk-pullup">
            <slot name="pullup">
                ...
                <circular class="wk-pull-circular" v-show="pullUpLoading" :size="24" color="carbon"></circular>
                <span class="wk-pulldown-scroll-text">正在加载。。。</span>
            </slot>
        </div>
    </div>
    ...
    export default {
        ...
        mounted(){
            ...
            this.$refs.pullcontent.addEventListener('touchstart', (e) => {
                this.$refs.pullcontent.classList.remove('wk-animated-time');
                this.$refs.pulldown.classList.remove('wk-animated-time');
                this.$refs.pullup.classList.remove('wk-animated-time');
...
//                    this.$refs.pullcontentmask.style.display="block"
            ...
            this.$refs.pullcontent.addEventListener('touchmove', (e) => {
                ...
                if (this.pullDown && this.pullDownLoading == false && isTop && distance > 0) {
                    ...
                    this.$refs.pulldown.style.webkitTransform = 'translate3d(0,' + distance / 3 + 'px,0)';
                    //this.$refs.pullcontent.style.transform = 'translate3d(0,' + distance / 2 + 'px,0)';
                    this.$refs.pullcontent.style.webkitTransform = 'translate3d(0,' + distance / 2 + 'px,0)';


                    //角度控制
                    if (distance / 2 <= 180) {
                        this.$refs.pulldown_arrow.$el.style.webkitTransform = 'rotate(' + (distance / 2 ) + 'deg)'
                    }
                    //控制箭头
                    if (this.contentOffsetTop / 2 > this.pulldownHeight) {
                        this.$refs.pulldown_arrow.$el.style.webkitTransform = 'rotate(180deg)'
                    } else {
                        this.$refs.pulldown_arrow.$el.style.webkitTransform = 'rotate(0deg)'
                    }
                }
                //上拉效果
                ...
                if (this.pullUp && this.pullUpLoading == false && isBottom && distance < 0) {
                    ...
                    this.$refs.pullup.style.webkitTransform = 'translate3d(0,' + distance / 3 + 'px,0)';
                    this.$refs.pullcontent.style.webkitTransform = 'translate3d(0,' + distance / 2 + 'px,0)';
                    if (distance / 2 <= 180) {
                        this.$refs.pullup_arrow.$el.style.webkitTransform = 'rotate(' + (distance / 2 ) + 'deg)'
                    }
                    //控制箭头
                    if (this.contentOffsetBottom / 2 > -this.pulldownHeight) {
                        this.$refs.pullup_arrow.$el.style.webkitTransform = 'rotate(180deg)'
                    } else {
                        this.$refs.pullup_arrow.$el.style.webkitTransform = 'rotate(0deg)'
                    }
                }
            ...
            this.$refs.pullcontent.addEventListener('touchend', (e) => {
                ...
                if (isPullDown) {
                    if (this.contentOffsetTop > this.pulldownHeight) {
                        ...
                        this.$refs.pullcontent.style.webkitTransform = 'translate3d(0,' + this.pulldownHeight + 'px,0)';
                        this.$refs.pulldown.style.webkitTransform = 'translate3d(0,' + this.pulldownHeight + 'px,0)';
                        this.$refs.pulldown_arrow.$el.style.webkitTransform = 'rotate(180deg)'
                        this.pullDownLoading = true;
                        let next = () => {
                            this.startY = 0;
                            this.contentOffsetTop = 0;
                            this.$refs.pullcontent.style.webkitTransform = 'translate3d(0,0px,0)';
                            this.$refs.pulldown.style.webkitTransform = 'translate3d(0,0px,0)';
                            setTimeout(() => {
...
//                                this.$refs.pullcontentmask.style.display="none"
                        ...
                        this.$refs.pullcontent.style.webkitTransform = 'translate3d(0,0,0)';
                        this.$refs.pulldown.style.webkitTransform = 'translate3d(0,0,0)';
                        this.$refs.pulldown_arrow.$el.style.webkitTransform = 'rotate(0deg)'
                        this.pullDownLoading = false;
//                        this.$refs.pullcontentmask.style.display="none"
                ...
                if (isPullUp) {
                    if ((0 - this.contentOffsetBottom) > this.pullupHeight) {
                        this.$refs.pullcontent.style.webkitTransform = 'translate3d(0,' + -this.pullupHeight + 'px,0)';
                        this.$refs.pullup.style.webkitTransform = 'translate3d(0,' + -this.pullupHeight + 'px,0)';
                        this.$refs.pullup_arrow.$el.style.webkitTransform = 'rotate(180deg)'
                        ...
                        let next = () => {
                            ...
                            this.$refs.pullcontent.style.webkitTransform = 'translate3d(0,0px,0)';
                            this.$refs.pullup.style.webkitTransform = 'translate3d(0,0px,0)';
                            setTimeout(() => {
...
//                                this.$refs.pullcontentmask.style.display="none"
                        ...
                        this.$refs.pullcontent.style.webkitTransform = 'translate3d(0,0px,0)';
                        this.$refs.pullup.style.webkitTransform = 'translate3d(0,0,0)';
                        this.$refs.pullup_arrow.$el.style.webkitTransform = 'rotate(0deg)'
                        this.pullUpLoading = false;
//                        this.$refs.pullcontentmask.style.display="none"
